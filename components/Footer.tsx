...
export default function Footer() {
  return (
    <footer className="w-full dark:bg-gray-900 dark:text-white py-4 px-8 flex flex-col justify-center items-center border-t gap-2">
      <span className="text-sm text-gray-200">© {new Date().getFullYear()} Flight Time Calculator. All rights reserved.</span>
      <span className="text-sm text-gray-200">Made with ❤️ by
        <a
