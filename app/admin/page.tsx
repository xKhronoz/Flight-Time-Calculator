...
export default function AdminHome() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-10 space-y-6">
      ...
      <div className="rounded-2xl border border-slate-800 dark:bg-slate-900/40 p-4 space-y-3">
        <h2 className="font-medium">Airport Database — Quick Reseed</h2>
        <div className="flex gap-2">
          <button onClick={() => callReseed(false)} className="px-4 py-2 mr-2 rounded-xl border bg-slate-400 dark:bg-slate-700 hover:bg-slate-600">
            Reseed (upsert)
          </button>
          <button onClick={() => callReseed(true)} className="px-4 py-2 rounded-xl border bg-rose-600 hover:bg-rose-500">
            Reset & Reseed
          </button>
        </div>
        {msg && <div className="text-sm dark:text-slate-300">{msg}</div>}
      ...
      <div className="rounded-2xl border border-slate-800 dark:bg-slate-900/40 p-4 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <label className="flex items-center gap-2">
            ...
            <input
              ...
              className="w-28 rounded-lg dark:bg-slate-800 border border-slate-700 px-3 py-2"
            />
          </label>
          ...
          <label className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-lg dark:bg-slate-800 border border-slate-700 px-3 py-2"
            >
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            disabled={running}
            className="px-4 py-2 rounded-xl border border-slate-700 bg-slate-400 dark:bg-slate-700 hover:bg-slate-600 disabled:opacity-50"
          >
        ...
        <div className="space-y-2">
          <div className="text-sm dark:text-slate-400">Progress</div>
          <div className="w-full h-3 dark:bg-slate-800 rounded-full overflow-hidden">
        ...
        <div className="space-y-2">
          <div className="text-sm dark:text-slate-400">Log</div>
          <div className="text-xs max-h-64 overflow-auto dark:bg-slate-900 border border-slate-800 rounded-xl p-3 font-mono whitespace-pre-wrap">
            {log.join('\n')}
          </div>
        </div>
      </div>
